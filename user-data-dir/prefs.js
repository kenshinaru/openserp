...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1730649459);
user_pref("app.update.lastUpdateTime.background-update-timer", 1730649459);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1730649459);
user_pref("app.update.lastUpdateTime.region-update-timer", 1730649459);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1730649459);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1730649489);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1730649459);
...
user_pref("browser.contextual-services.contextId", "{01decbbb-7be4-4bd1-ab1c-62d40da4ede3}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{62a7dbf4-670a-4751-b603-34c7bcb0e4d4}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20241002214819");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1730649687);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECHR3fUbJdChIBAi0mCnwiE07nQ==");
user_pref("extensions.formautofill.creditCards.supported", "off");
user_pref("extensions.getAddons.cache.enabled", false);
user_pref("extensions.installDistroAddons", false);
user_pref("extensions.lastAppBuildId", "20241002214819");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"1dbce51d-7fca-471f-bb58-55d422a8fb44\",\"pictureinpicture@mozilla.org\":\"feee0e33-5032-48a3-8ad7-f441de7ea0e0\",\"screenshots@mozilla.org\":\"809e2e33-e72a-471d-b781-82d8af3fd031\",\"webcompat-reporter@mozilla.org\":\"9563762c-273d-4e8a-9cdf-6c0e3e920270\",\"webcompat@mozilla.org\":\"9243a7bb-ac89-4cef-9dbb-57826db447fc\",\"default-theme@mozilla.org\":\"77d3a685-fe68-4fd6-85a4-b900723172fd\",\"addons-search-detection@mozilla.com\":\"1d2e85fc-dd85-4061-8019-6cbc153d9a26\"}");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECGeR970lBo8zBAjhVX/gwelJcQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1730649685);
...
user_pref("toolkit.telemetry.previousBuildID", "20241002214819");
